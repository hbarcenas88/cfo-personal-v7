...
4. **Urgente — estabilidad móvil de Registro.** Diseño aprobado el 2026-07-26 en `docs/superpowers/specs/2026-07-26-mobile-record-stability-design.md`; pendiente de revisión de especificación y plan técnico. Centraliza continuidad de escritura, selector sin teclado automático, calculadora clásica compartida y recorrido de una pantalla a 390 × 844, sin alterar datos financieros.
