...
4. **Urgente — estabilidad móvil de Registro.** Diseño y plan aprobados el 2026-07-26 en `docs/superpowers/specs/2026-07-26-mobile-record-stability-design.md` y `docs/superpowers/plans/2026-07-26-mobile-record-stability-implementation.md`; pendiente de implementación y verificación. Centraliza continuidad de escritura, selector sin teclado automático, calculadora clásica compartida y recorrido de una pantalla a 390 × 844, sin alterar datos financieros.
